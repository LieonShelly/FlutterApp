...
List<Story> getStories(WonderThemeData theme) {
  return [
    Story.simple(
      ...
      section: 'Buttons',
      child: ExpandedElevatedButton(label: "Press me", onTap: () {}),
    ),
    ...
    Story(
      ...
      builder: (_, k) => ExceptionIndicator(
        ...
        onTryAgain: k.boolean(label: 'onTryAgain', initial: false)
            ? () {}
            : null,
      ),
    ),
    ...
    Story(
      ...
      builder: (_, k) => RoundedChoiceChip(
        label: k.text(label: 'label', initial: 'I am a Chip!'),
        ...
        avatar: k.boolean(label: 'avatar', initial: false)
            ...
            : null,
        onSelected: k.boolean(label: 'onSelected', initial: true)
            ? (_) {}
            : null,
        ...
        selectedBackgroundColor: k.options(
          ...
          options: const [
            ...
            Option('Amber accent', Colors.amberAccent),
          ],
        ),
        labelColor: k.options(
          ...
          initial: null,
          options: const [
            Option('Teal', Colors.teal),
            Option('Orange accent', Colors.orangeAccent),
          ],
        ),
        selectedLabelColor: k.options(
          ...
          initial: null,
          options: const [
            Option('Deep purple accent', Colors.deepPurpleAccent),
            Option('Amber accent', Colors.amberAccent),
          ],
        ),
      ),
    ...
    Story(
      ...
      builder: (_, k) => ChevronListTile(
        label: k.text(label: 'label', initial: 'Update Profile'),
      ),
    ),
    Story.simple(name: 'Search Bar', child: const SearchBar()),
    Story.simple(
      name: 'Row App Bar',
